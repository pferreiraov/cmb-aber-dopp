...
vec_l = np.array([750,850,950,1050,1150])
cmap_test = colors.LinearSegmentedColormap.from_list("t", ["red","orange","green","blue","purple"])
cmap_func = matplotlib.cm.get_cmap(cmap_test)

ab_vec_nilc = np.array([np.loadtxt("data/48dir_ut78symm_2018_apod10_debeamed_noise_nilc_EE_v2_EE_v2_w_DD_results_ab_dopp_abdopp_sim_estimator_final_clfrac_ABSUnbiasedVEC_lmin_"+str(lmin)+"_lmax_"+str(i)+".dat")[0] for i in vec_l])
dopp_vec_nilc = np.array([np.loadtxt("data/48dir_ut78symm_2018_apod10_debeamed_noise_nilc_EE_v2_EE_v2_w_DD_results_ab_dopp_abdopp_sim_estimator_final_clfrac_ABSUnbiasedVEC_lmin_"+str(lmin)+"_lmax_"+str(i)+".dat")[1] for i in vec_l])
abdopp_vec_nilc = np.array([np.loadtxt("data/48dir_ut78symm_2018_apod10_debeamed_noise_nilc_EE_v2_EE_v2_w_DD_results_ab_dopp_abdopp_sim_estimator_final_clfrac_ABSUnbiasedVEC_lmin_"+str(lmin)+"_lmax_"+str(i)+".dat")[2] for i in vec_l])

ab_vec_smica = np.array([np.loadtxt("data/48dir_ut78symm_2018_apod10_debeamed_noise_smica_EE_v2_EE_v2_w_DD_results_ab_dopp_abdopp_sim_estimator_final_clfrac_ABSUnbiasedVEC_lmin_"+str(lmin)+"_lmax_"+str(i)+".dat")[0] for i in vec_l])
dopp_vec_smica = np.array([np.loadtxt("data/48dir_ut78symm_2018_apod10_debeamed_noise_smica_EE_v2_EE_v2_w_DD_results_ab_dopp_abdopp_sim_estimator_final_clfrac_ABSUnbiasedVEC_lmin_"+str(lmin)+"_lmax_"+str(i)+".dat")[1] for i in vec_l])
abdopp_vec_smica = np.array([np.loadtxt("data/48dir_ut78symm_2018_apod10_debeamed_noise_smica_EE_v2_EE_v2_w_DD_results_ab_dopp_abdopp_sim_estimator_final_clfrac_ABSUnbiasedVEC_lmin_"+str(lmin)+"_lmax_"+str(i)+".dat")[2] for i in vec_l])
...
#
laterror_smica = np.loadtxt('data/smicaEE1sigmaelipsevalues.dat')[:,1]
longerror_smica = np.loadtxt('data/smicaEE1sigmaelipsevalues.dat')[:,0]

laterror_smica2 = np.loadtxt('data/smicaEE2sigmaelipsevalues.dat')[:,1]
longerror_smica2 = np.loadtxt('data/smicaEE2sigmaelipsevalues.dat')[:,0]
...
error_bar(dopplat,dopplon,0.5,6,6,dopplaterror1,dopplongerror1,dopplaterror2,dopplongerror2)

laterror_nilc = np.loadtxt('data/nilcEE1sigmaelipsevalues.dat')[:,1]
longerror_nilc = np.loadtxt('data/nilcEE1sigmaelipsevalues.dat')[:,0]

laterror_nilc2 = np.loadtxt('data/nilcEE2sigmaelipsevalues.dat')[:,1]
longerror_nilc2 = np.loadtxt('data/nilcEE2sigmaelipsevalues.dat')[:,0]
...
error_bar(dopplat,dopplon,0.5,6,6,dopplaterror1,dopplongerror1,dopplaterror2,dopplongerror2,ticks=True)
...
plt.savefig('mollview_varing_EE_lmax_AB+DOPP_max1800_ticks_one_column_v3.pdf',dpi=600, bbox_inches = 'tight',pad_inches = 0)
