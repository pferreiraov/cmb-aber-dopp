...
ab_vec_nilc_dD = np.array([np.loadtxt("dedopplered_data/48dir_ut78symm_2018_apod10_dedopplered_noise_nilc_results_ab_dopp_abdopp_sim_estimator_clfrac_ABSUnbiasedVEC_lmin_"+str(lmin)+"_lmax_"+str(i)+".dat")[0] for i in vec_l])
dopp_vec_nilc_dD = np.array([np.loadtxt("dedopplered_data/48dir_ut78symm_2018_apod10_dedopplered_noise_nilc_results_ab_dopp_abdopp_sim_estimator_clfrac_ABSUnbiasedVEC_lmin_"+str(lmin)+"_lmax_"+str(i)+".dat")[1] for i in vec_l])
abdopp_vec_nilc_dD = np.array([np.loadtxt("dedopplered_data/48dir_ut78symm_2018_apod10_dedopplered_noise_nilc_results_ab_dopp_abdopp_sim_estimator_clfrac_ABSUnbiasedVEC_lmin_"+str(lmin)+"_lmax_"+str(i)+".dat")[2] for i in vec_l])

ab_vec_smica_dD = np.array([np.loadtxt("dedopplered_data/48dir_ut78symm_2018_apod10_dedopplered_noise_smica_results_ab_dopp_abdopp_sim_estimator_clfrac_ABSUnbiasedVEC_lmin_"+str(lmin)+"_lmax_"+str(i)+".dat")[0] for i in vec_l])
dopp_vec_smica_dD = np.array([np.loadtxt("dedopplered_data/48dir_ut78symm_2018_apod10_dedopplered_noise_smica_results_ab_dopp_abdopp_sim_estimator_clfrac_ABSUnbiasedVEC_lmin_"+str(lmin)+"_lmax_"+str(i)+".dat")[1] for i in vec_l])
abdopp_vec_smica_dD = np.array([np.loadtxt("dedopplered_data/48dir_ut78symm_2018_apod10_dedopplered_noise_smica_results_ab_dopp_abdopp_sim_estimator_clfrac_ABSUnbiasedVEC_lmin_"+str(lmin)+"_lmax_"+str(i)+".dat")[2] for i in vec_l])
...
abdopplaterror1=abdopplaterror1
abdopplongerror1=abdopplongerror1
...
plt.savefig('mollview_varing_lmax_TT_PECVEC_max1800_ticks_one_column_v4.pdf',dpi=600, bbox_inches = 'tight',pad_inches = 0)
