...
#vec_l = np.array([750,800,850,900,950])
vec_l = np.array([750,850,950,1050,1150])
cmap_test = colors.LinearSegmentedColormap.from_list("t", ["red","orange","green","blue","purple"])
cmap_func = matplotlib.cm.get_cmap(cmap_test)

ab_vec_nilc = np.array([np.loadtxt("data/48dir_ut78symm_2018_apod10_debeamed_noise_nilc_EE_v2_w_DD_results_only_abdopp_sim_estimator_clfrac_ABSUnbiasedVEC_lmin_"+str(lmin)+"_lmax_"+str(i)+".dat")[0] for i in vec_l])
dopp_vec_nilc = np.array([np.loadtxt("data/48dir_ut78symm_2018_apod10_debeamed_noise_nilc_EE_v2_w_DD_results_only_abdopp_sim_estimator_clfrac_ABSUnbiasedVEC_lmin_"+str(lmin)+"_lmax_"+str(i)+".dat")[1] for i in vec_l])
abdopp_vec_nilc = np.array([np.loadtxt("data/48dir_ut78symm_2018_apod10_debeamed_noise_nilc_EE_v2_w_DD_results_only_abdopp_sim_estimator_clfrac_ABSUnbiasedVEC_lmin_"+str(lmin)+"_lmax_"+str(i)+".dat")[2] for i in vec_l])

ab_vec_smica = np.array([np.loadtxt("data/48dir_ut78symm_2018_apod10_debeamed_noise_smica_EE_v2_w_DD_results_only_abdopp_sim_estimator_clfrac_ABSUnbiasedVEC_lmin_"+str(lmin)+"_lmax_"+str(i)+".dat")[0] for i in vec_l])
dopp_vec_smica = np.array([np.loadtxt("data/48dir_ut78symm_2018_apod10_debeamed_noise_smica_EE_v2_w_DD_results_only_abdopp_sim_estimator_clfrac_ABSUnbiasedVEC_lmin_"+str(lmin)+"_lmax_"+str(i)+".dat")[1] for i in vec_l])
abdopp_vec_smica = np.array([np.loadtxt("data/48dir_ut78symm_2018_apod10_debeamed_noise_smica_EE_v2_w_DD_results_only_abdopp_sim_estimator_clfrac_ABSUnbiasedVEC_lmin_"+str(lmin)+"_lmax_"+str(i)+".dat")[2] for i in vec_l])
...
plt.savefig('mollview_varing_lmax_EE_PECVEC_max1800_ticks_one_column_v3.pdf',dpi=600, bbox_inches = 'tight',pad_inches = 0)
